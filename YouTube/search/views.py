...
class ChannelFilter(filters.FilterSet):
    ...
    owner = filters.CharFilter(field_name='owner__slug', lookup_expr='exact')
...
class SubChannelFilter(filters.FilterSet):
    ...
    admin = filters.NumberFilter(field_name='admins__id')
    subscriber = filters.NumberFilter(field_name='subscribers__id')
